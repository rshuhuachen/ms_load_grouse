...
![Results per genomic region per GO term for GERP](../plots/extended/extended_5_go_gerp.png)

![Results per genomic region per GO term for SnpEff](../plots/extended/extended_6_go_snpeff.png)
...
These results indicate the results really depend on the GO term and region in question. But three patterns are clear:
- GERP mutations in promoters of many GO terms are deleterious
- GERP mutations in two or more genomic regions of the GO terms: androgen metabolism, immune response and response to oxidative stress are deleterious
- High impact SnpEff mutations in all genomic regions of immune response are negative
