...
Here you can find the posterior distributions of model set 1 (load on traits) for GERP and SnpEff: ![MS set 1 results GERP](../plots/main/fig_3_left_load_traits.png)

![MS set 1 results SnpEff](../plots/sup/extended_4_high_left_load_traits.png)

And for model set 2 (traits on MS) for GERP and SnpEff: ![MS set 2 results GERP](../plots/main/fig_3_right_traits_ams.png)

![MS set 2 results SnpEff](../plots/sup/extended_4_high_right_traits_ams.png)
