...
png(file = "plots/extended/extended_2a_hist_gerp.png", width=800, height=600)
hist_loads_gerp
dev.off()
...
png(file = "plots/extended/extended_2b_hist_high.png", width=800, height=600)
hist_loads_high
dev.off()
...
png(file = "plots/extended/extended_2c_froh_load.png", width=800, height=600)
froh_load
dev.off()
...
png(file = "plots/extended/extended_2_load_froh.png", width=800, height=1000)
fig_loads
dev.off()
